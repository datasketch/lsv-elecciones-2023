...
const initialState = {
  ...
  blocks: {
    ...
    presidential: [
      ...
      ['Ha tenido la responsabilidad de tomar decisiones determinantes para el país', 'responsibilityForDecisiveDecisionsForTheCountry'],
      ...
      ['Popularidad con la que terminó el último cargo en el Ejecutivo', 'mostRecentFavorability'],
      ['Máximo cargo en el sector privado', 'highestPositionInThePrivateSector'],
      ['Apoyó el Paro', 'supportedTheStrike'],
      ['Obligar a funcionarios públicos a vacunarse', 'forcingPublicOfficialsToGetVaccinated'],
    ],
  },
  candidates: {
    main: '',
